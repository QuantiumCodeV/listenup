...
$users = mysqli_query($mysqli, "SELECT * FROM `logs`");
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
      ...
      <div class="card">
          ...
          <div class="mb-2 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Поиск логов" aria-label="Поиск логов">
              </div>
              <!-- End Search -->
            </form>
          </div>
        ...
        <th>Месяц</th>
        <th>Год</th>
        <th>Лиц. Уд. Личности</th>
        <th>Обр. Уд. Личности</th>
        <th>Селфи с документом</th>
        <th>Лиц. Вод. права</th>
        <th>Обр. Вод. права</th>
        <th>Лиц. Кар. здоровья</th>
        <th>Обр. Кар. здоровья</th>
        <th>PDF1</th>
        <th>PDF2</th>
        <th>PDF3</th>
        <th>IBAN</th>
                    ...
                    <tr>
                        <td class="table-column-pe-0">
                            <a class="d-flex align-items-center" href="./user-profile.html">
                                <div class="ms-3">
                                    <span class="d-block h5 text-inherit mb-0"><?= $user['nome'] ?></span>
                                </div>
                            </a>
                        </td>
                        <td>
                            <span class="d-block h5 mb-0"><?= $user['cognome'] ?></span>         
                        </td> 
                        <td>
                            <span class="d-block fs-5"><?= $user['cod'] ?></span>
                        </td>
                        <td><?= $user['tel'] ?></td>
                        <td>
                            <?= $user['email'] ?>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <span class="fs-5 me-2"><?= $user['giorno'] ?></span>
                              
                            </div>
                        </td>
                        <td><?= $user['month'] ?></td>
                        <td><?= $user['year'] ?></td>
                        <td><a href="../<?= $user['CIF'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['CIR'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['SELFIE'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['CIF1'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['CIR1'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['CIF2'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['CIR2'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['CIF3'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><a href="../<?= $user['CIR3'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td> <a href="../<?= $user['SELFIE3'] ?>" download class="btn btn-white btn-sm">
                                <i class="bi-pencil-fill me-1"></i> Скачать
              </a></td>
                        <td><?= $user['iban'] ?></td>
                        <td>
                            <button type="button" data-id="<?= $user['id'] ?>" class="btn btn-outline-danger btn-sm">
